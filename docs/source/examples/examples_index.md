...
If you are new to `synthpop-py`, we recommend starting with the **Getting started** examples before exploring alternative synthesis methods, parameter tuning and custom components.
