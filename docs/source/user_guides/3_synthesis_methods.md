...
### Direct use of `CartMethod` {toc=False}
...
## How Sample synthesis works {toc=False}
...
## When to use Sample synthesis {toc=False}
...
## Direct use of `SampleMethod` {toc=False}
...
### How Copy synthesis works {toc=False}
...
### When to use Copy synthesis {toc=False}
...
### Direct use of `CopyMethod` {toc=False}
