...
- the implementation does not provide modern performance-oriented features such as parallel synthesis or hardware acceleration.

synthpop-py addresses these limitations while preserving the sequential modelling approach introduced by synthpop. The goals of the project are to make synthetic data generation more accessible and easier to deploy in production environments.
