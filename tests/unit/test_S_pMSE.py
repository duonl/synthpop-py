...
@pytest.mark.parametrize(
    ...
    [
        ...
        pd.DataFrame({"column1": ["c1", "c1", "c2"],"column2": ["c1", "c2", "c2"],"S_pMSE": [2/3, 2/3, 2/3]}), 1000), 
        #A non-zero answer to the S_pMSE, calculated by hand, with a high value of bins
        
        (pd.DataFrame({"c1": [0,1,2]}),
        pd.DataFrame({"c1": [1,2]}),
        pd.DataFrame({"column1": ["c1"], "column2": ["c1"], "S_pMSE": [1/9]}), 2), 
        #Check for two bins

        (pd.DataFrame({"c1": [0,1,2]}),
        pd.DataFrame({"c1": [1,2]}),
        pd.DataFrame({"column1": ["c1"], "column2": ["c1"], "S_pMSE": [1/6]}), 3), 
        ...
        pd.DataFrame({"c1": ['b','c']}),
        pd.DataFrame({"column1": ["c1"], "column2": ["c1"], "S_pMSE": [1/6]}), 25), 
        ...
        pd.DataFrame({"c1": [0, 1]}),
        pd.DataFrame({"column1": ["c1"], "column2": ["c1"], "S_pMSE": [1/4]}), 25),
