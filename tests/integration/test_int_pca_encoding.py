...
def test_pca_encoding_fit_constant_target():
    ...
    # floating point errors occur.
    assert encoder.mapping_["a"] == pytest.approx([1 / sqrt2])
...
def test_pca_encoding_not_broken_by_setoutput_api():
    ...
    # Using the setoutput api here via a context manager
    # could have effect on sklearn.PCA
