...
def rigged_tree_classifier_method(pca_components = 1):
    tree = SpyDecisionTreeClassifier(random_state = RandomStateManager.create_instance_seed())
...
def rigged_tree_regressor_method():
    tree = SpyDecisionTreeRegressor(random_state = RandomStateManager.create_instance_seed())
